        ...
        with tf.device("/cpu:0"):
            with tf.variable_scope('input') as scope:
                ...
                with tf.variable_scope('train_data') as scope:
                    ...
                    single_sample[0] = tf.py_func(readNumpy, single_sample[0])
                    single_sample[1] = tf.py_func(readNumpy, single_sample[1])
                    single_sample[2] = tf.py_func(readNumpy, single_sample[2])
                    single_sample[3] = tf.py_func(readNumpy, single_sample[3])
